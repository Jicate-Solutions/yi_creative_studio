...
export function mergeAIContextWithPreset(
  ...
  // v30.0: Always use AI-only context — no preset visual element injection
  // This prevents visual convergence where different events matching the same
  // preset category (e.g., "awareness_campaign") get identical visuals.
  console.log('[AI Context Merge] v30.0 - Using AI-only context (no preset visuals)')
