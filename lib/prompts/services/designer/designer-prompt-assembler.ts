/**
 * Designer Prompt Assembler — v54.0 (Designer fork only)
 *
 ...
 *
 * ISOLATION: only imported by app/api/generate-designer/route.ts.
 */

import type { DirectorOutput } from '@/lib/agents/designer-creative-director'
 ...
 */
export function assembleDesignerPrompt(
  ...
  // (designer-creative-director.ts principle 18) and emits them as structured fields, so we
